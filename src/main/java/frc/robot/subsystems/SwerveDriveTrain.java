...
public class SwerveDriveTrain extends SubsystemBase{
    ...
    public SwerveDriveTrain(double distanceFromOrigin, int turn1, int drive1, int turn2, int drive2, int turn3, int drive3, int turn4, int drive4){
        ...
        mod4 = new SwerveModule(turn4, drive4);
        mod1.reset();
        mod2.reset();
        mod3.reset();
        mod3.reset();
    ...
    public void updatePeriodic(double translateX, double translateY, double yaw){
        ...
        // speed = ChassisSpeeds.fromFieldRelativeSpeeds(translateX * MAX_SPEED, translateY * MAX_SPEED * -1, yaw * MAX_RADIANS, new Rotation2d(Math.toRadians(getGyroAngle())));
        ...
        speed.omegaRadiansPerSecond = yaw * MAX_RADIANS;
